...
FETCH_HI_BUFFER_S = 5
CHUNK_SIZE = 700
MAX_TOTAL_COST_CREDITS = 300.0  # предохранитель за один прогон (один день), ниже общего кэпа
MAX_DAYS_PER_RUN = 1
...
def main() -> None:
    ...
    day_priority = {"2026-09-17": 0, "2026-09-16": 1, "2026-09-15": 2, "2026-09-18": 3}
