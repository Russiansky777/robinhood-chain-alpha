...
BATCH_MIN_INTERVAL_S = 0.5  # реальный найденный 429 на 0.12с/40-чанк (run 35227000572,
# status_code=429 захвачен диагностикой) -- отступаем с гораздо большим запасом
...
MAX_BATCH_SIZE = 20  # уменьшено с 40 после реального 429 (run 35227000572)
