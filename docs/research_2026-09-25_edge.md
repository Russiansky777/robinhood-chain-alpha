# Ночь 25.09: боевое и исследование (доклад собран 2026-09-25T03:16:39Z)

## 1. Боевое

**Решения по сигналам.** Покупок 8; по кодам: {"NOT_A_BUY": 162, "TARGET_AMOUNT_OUT_OF_RANGE": 103, "SKIP_TARGET_INCREASE_POSITION": 100, "TOKEN_RECEIVED_NOT_BOUGHT": 78, "BUY": 8, "SKIPPED_DUP_MINT": 2, "THRESHOLD_EDGE": 1, "SKIP_TAXED_ROUTE": 1}. Полоса идёт только там, где мы покупаем, поэтому её тишина объясняется этой строкой.
...
**Тень.** Записей 75, по вердиктам: {"would_pass": 18, "нет вердикта": 57}. Медиана сборки 0.84 мс, симуляции 15.9 мс.
...
{
  "ok": true,
  "built_utc": "2026-09-25T03:16:39Z",
  "pickaxe": {
    "ok": true,
