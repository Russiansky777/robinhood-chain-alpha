# Ночь 25.09: боевое и исследование (доклад собран 2026-09-25T02:24:07Z)

## 1. Боевое

**Решения по сигналам.** Покупок 7; по кодам: {"NOT_A_BUY": 118, "TARGET_AMOUNT_OUT_OF_RANGE": 90, "SKIP_TARGET_INCREASE_POSITION": 69, "TOKEN_RECEIVED_NOT_BOUGHT": 68, "BUY": 7, "SKIPPED_DUP_MINT": 2, "THRESHOLD_EDGE": 1}. Полоса идёт только там, где мы покупаем, поэтому её тишина объясняется этой строкой.
...
**Тень.** Записей 29, по вердиктам: {"would_pass": 8, "нет вердикта": 21}. Медиана сборки 0.73 мс, симуляции 14.35 мс.
